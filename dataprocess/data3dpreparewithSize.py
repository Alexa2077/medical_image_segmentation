...
def preparetraindata():
    ...
    src_train_path = r"./dataset/STS_nii"
    source_process_path = r"./dataset/STS_npy"

    outputimagepath = source_process_path + "/" + image_dir
    outputlabelpath = source_process_path + "/" + mask_dir
    preparesampling3dtraindata(src_train_path, outputimagepath, outputlabelpath, (256, 256, 256))
